...
python nii_to_jpg.py --nii_file InfNet/Dataset/tr_mask.nii --filename_prefix tr --output_folder InfNet/Dataset/TrainingSet/MultiClassInfection-Train/Prior/ --save_type png --is_binary True
