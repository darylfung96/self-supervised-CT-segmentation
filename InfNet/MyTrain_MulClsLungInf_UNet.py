...
def train(epo_num, num_classes, input_channels, batch_size, lr, is_data_augment, is_label_smooth, random_cutout,
    ...
    for epo in range(epo_num):
        ...
        for index, (img, pseudo, img_mask, name) in enumerate(test_dataloader):
            ...
            dice = dice_similarity_coefficient(output, img_mask, None)
            jaccard = jaccard_similarity_coefficient(output, img_mask, None)
            sensitivity = sensitivity_similarity_coefficient(output, img_mask, None)
            precision = precision_similarity_coefficient(output, img_mask, None)
