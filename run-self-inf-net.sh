...
# baseline cross-val
python MyTrain_LungInf.py --train_save baseline-inf-net-cross-val --fold 3 --eval_threshold 0.5 --random_cutout 0 --seed 100 --graph_path graph_baseline-inf-net-cross-val --device cuda --epoch 500 --batchsize 8
