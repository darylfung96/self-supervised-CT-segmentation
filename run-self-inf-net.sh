...
python MyTrain_LungInf.py --train_save self-inf-net --random_cutout 0 --graph_path graph_self-inf-net --load_net_path ../model/self-inf-net/medseg_resnet18_autoencoder_no_bottleneck_use_coach10.net.best.ckpt.t7 --device cuda --epoch 500 --batchsize 8
