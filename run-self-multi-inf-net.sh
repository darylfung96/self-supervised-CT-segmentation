...
# cross-val
python MyTrain_MulClsLungInf_UNet.py --folds 3 --save_path multi-inf-net-cross-val --random_cutout 0  --graph_path graph_multi-inf-net-cross-val --device cuda --epoch 500 --batchsize 4
